...
namespace AcademiaDanca.IO.Dominio.Contexto.Repositorio
{
    public interface IFinanceiroRepositorio
    {
        ...
        Task<List<MensalidadesQueryResultado>> ObterMensalidadesPorAlunoAsync(Guid? uifIdAluno, string status, int? ano, int? tipo);
        ...
        Task<IEnumerable<ItemMatriculaQueryResultado>> ObterMatriculaItensPor(Guid idMatriculaGuid);
